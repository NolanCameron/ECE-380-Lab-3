...
class ECE380Lab3Ex3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ECE380Lab3Ex3")
        ...
        # Variables
        ##################################################
        self.f_carrier = f_carrier = 630000
        self.samp_rate = samp_rate = f_carrier*30
        self.mod_index = mod_index = 1
        self.f_audio = f_audio = 15000

        ##################################################
        # Blocks
        ##################################################
        self._mod_index_range = Range(0, 2, 0.1, 1, 200)
        self._mod_index_win = RangeWidget(self._mod_index_range, self.set_mod_index, "'mod_index'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        labels = ['Test Signal', 'AM Signal', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, f_audio, mod_index, 0, 0)
    ...
    def set_f_carrier(self, f_carrier):
        ...
        self.set_samp_rate(self.f_carrier*30)
    ...
    def set_mod_index(self, mod_index):
        ...
        self.analog_sig_source_x_0.set_amplitude(self.mod_index)
    ...
    def set_f_audio(self, f_audio):
        ...
        self.analog_sig_source_x_0.set_frequency(self.f_audio)




def main(top_block_cls=ECE380Lab3Ex3, options=None):
