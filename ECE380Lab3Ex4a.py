...
class ECE380Lab3Ex4a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ECE380Lab3Ex4a")
...
def main(top_block_cls=ECE380Lab3Ex4a, options=None):
