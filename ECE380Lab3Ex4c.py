...
class ECE380Lab3Ex4c(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ECE380Lab3Ex4c")
        ...
        self._volume_win = qtgui.RangeWidget(self._volume_range, self.set_volume, "Audio Volume", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_fcf(interp, firdes.low_pass(1,samp_rate,samp_rate/(2*interp),2000), station_freq, samp_rate)
    ...
    def set_interp(self, interp):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(firdes.low_pass(1,self.samp_rate,self.samp_rate/(2*self.interp),2000))
    ...
    def set_audio_samp_rate(self, audio_samp_rate):
        ...
        self.set_samp_rate(self.audio_samp_rate*self.interp*4)
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.audio_samp_rate, 500, 6000, 400, window.WIN_HAMMING, 6.76))
    ...
    def set_station_freq(self, station_freq):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_center_freq(self.station_freq)
...
def main(top_block_cls=ECE380Lab3Ex4c, options=None):
