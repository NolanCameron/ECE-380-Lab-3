...
class ECE380Lab3Ex1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ECE380Lab3Ex1")
        ...
        self._mod_index_range = qtgui.Range(0, 2, 0.1, 1, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, f_audio, mod_index, 0, 0)
...
def main(top_block_cls=ECE380Lab3Ex1, options=None):
